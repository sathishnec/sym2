...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // acme_task_new
        if ($pathinfo === '/new') {
            return array (  '_controller' => 'Acme\\TaskBundle\\Controller\\DefaultController::newAction',  '_route' => 'acme_task_new',);
        }

        // acme_task_success
        if ($pathinfo === '/success') {
            return array (  '_controller' => 'Acme\\TaskBundle\\Controller\\DefaultController::successAction',  '_route' => 'acme_task_success',);
        }
        ...
        // acme_store_addpc
        if ($pathinfo === '/addpc') {
            return array (  '_controller' => 'Acme\\StoreBundle\\Controller\\DefaultController::createProductCatAction',  '_route' => 'acme_store_addpc',);
        }

        // acme_store_showpc
        if (0 === strpos($pathinfo, '/showpc') && preg_match('#^/showpc/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'acme_store_showpc')), array (  '_controller' => 'Acme\\StoreBundle\\Controller\\DefaultController::showpcAction',));
        }

        // acme_store_valaut
        if ($pathinfo === '/valaut') {
            return array (  '_controller' => 'Acme\\StoreBundle\\Controller\\ValidationController::indexAction',  '_route' => 'acme_store_valaut',);
        }
